...
enum RedisCommand {
	...
	/**
	 * @return true if the command requires arguments
	 */
	...
	/**
	 * @return true if an exact number of arguments is expected
	 */
	...
	/**
	 * @return true if the command triggers a read operation
	 */
	...
	/**
	 * @return true if the command triggers a write operation
	 */
	...
	/**
	 * @return true if values are read but not written
	 */
	 ...
	 * 
	 * @param nrArguments
	 * @throws IllegalArgumentException in case argument count does not match expected.
	 */
